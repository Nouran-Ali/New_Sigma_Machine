        ...
        <div className='bg-[#2a2a2a] text-white rounded-lg p-5 px-9 max-xl:px-5 relative -bottom-7'>
            <div className='grid grid-cols-3 max-xl:grid-cols-2 gap-6 mt-20 mb-16 mx-16 max-xl:mx-4'>
                <div className='col-span-3 text-center'>
                    <p className='text-xl max-xl:text-lg tracking-widest uppercase font-medium'>Sigma Machines — Your Trusted Service Partner in Saudi Arabia</p>
                    <h3 className='mt-4 text-5xl max-xl:text-3xl font-bold'>
                        We don’t just sell machines. <br/>
                        We protect your investment, keep your production stable, and support you long-term.
                    </h3>
